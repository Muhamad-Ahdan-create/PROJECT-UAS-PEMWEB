{{-- resources/views/anggota/sisa-pinjaman.blade.php --}}
    ...
    @forelse($pinjaman as $p)
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                {{-- Sisa pinjaman besar --}}
                <div class="d-flex justify-content-between align-items-center p-3 rounded-3 mb-3" style="background:#fff5f5;">
                ...
                {{-- Accordion jadwal angsuran --}}
                <div class="accordion" id="acc{{ $p->id }}">
                    <div class="accordion-item border-0">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed py-2 small fw-semibold bg-light rounded" type="button"
                                data-bs-toggle="collapse" data-bs-target="#jadwal{{ $p->id }}">
                                        ...
                                        <tbody>
                                            @foreach($p->angsuran->sortBy('ke_bulan') as $a)
                                                <tr
                                                    ...
                                                    <td class="text-end fw-semibold small">Rp
                                                        {{ number_format($a->jumlah_bayar, 0, ',', '.') }}</td>
