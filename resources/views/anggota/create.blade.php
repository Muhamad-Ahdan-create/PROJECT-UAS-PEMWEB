{{-- resources/views/anggota/pengajuan/create.blade.php --}}
...
@section('content')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="number" name="jumlah_diajukan" id="inputJumlah"
                                    ...
                                    min="100000" max="50000000" step="50000" value="{{ old('jumlah_diajukan') }}"
                                    placeholder="Contoh: 5000000" required oninput="hitungSimulasi()">
                            ...
                            <div class="col-12" id="boxSimulasi" style="display:none;">
                                <div class="p-3 rounded-3 border border-primary-subtle" style="background:#eff6ff;">
                                    <div class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <span class="fw-semibold small text-primary">Simulasi Angsuran (Bunga 1.5%/bln
                                            flat)</span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <label class="form-label small fw-medium">Jaminan <span
                                        class="text-muted">(opsional)</span></label>
                                <input type="text" name="jaminan" class="form-control form-control-sm"
                                    value="{{ old('jaminan') }}" placeholder="Contoh: BPKB Motor, Sertifikat">
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="file" name="dokumen_path" class="form-control form-control-sm"
                    ...
                    <div class="card-body">
                        <div class="form-check">
                            ...
                            <label class="form-check-label small" for="chkSetuju">
                                Saya menyatakan data di atas benar dan sanggup membayar angsuran tepat waktu
    ...
    <script>
        ...
        function hitungSimulasi() {
            ...
            const bungaPersen = 0.015;
            const totalBunga = jumlah * bungaPersen * tenor;
